"""Gemini OpenAI-compat runner wiring around the protocol-agnostic core runner."""
...
from .client import GeminiClient, ThrottledGeminiClient
...
def _make_throttled_client(
    ...
    max_concurrent: int,
) -> ThrottledGeminiClient:
    return ThrottledGeminiClient(
        base_client,
...
async def _ttft_probe(client: ThrottledGeminiClient, model: str) -> None:
