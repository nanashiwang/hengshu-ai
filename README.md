...
| API | 用途 |
|---|---|
| `GET /v1/skills` | 公开读取 Skill 摘要列表，支持 `essential=1` 作为必备 Skill onboarding 接口，并返回必备推荐理由、可信榜排序依据、顶层 trustedCompatibleRunCount、Passport 可信摘要、API/页面证据验签入口、试跑入口和台账入口 |
