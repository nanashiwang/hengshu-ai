  ...
  it('从兼容统计和价格快照生成画像', () => {
    const data = buildModelProfileData({
      ...
      stat: {
        ...
        taskProfileSummary: [{ profileKey: '500-2k|schema_error|2026-07', inputBucket: '500-2k', errorType: 'schema_error', modelVersion: '2026-07', count: 2, effectiveSamples: 2, successRate: 0, formatRate: 0 }],
        skillProfileSummary: [{ profileKey: 'skill-1|500-2k|schema_error|2026-07', skillId: 'skill-1', skillSlug: 'writer', skillTitle: 'Writer', inputBucket: '500-2k', errorType: 'schema_error', modelVersion: '2026-07', count: 2, effectiveSamples: 2, successRate: 0, formatRate: 0 }],
      },
    ...
    const history = buildDriftHistory(
      {
        ...
        capabilities: {
          ...
          taskProfileSummary: [{ profileKey: '8k+|timeout|2026-07', inputBucket: '8k+', errorType: 'timeout', modelVersion: '2026-07', count: 2, effectiveSamples: 1, successRate: 0, formatRate: 0 }],
        },
