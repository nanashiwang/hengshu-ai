...
当前企业 Registry 已返回治理 checklist/playbook，串起组织内 Passport/证书复核、模型白名单、企业运行授权、企业私有评测、审计导出和组织内失败库。
...
| Enterprise Registry | 已有 | `EnterpriseRegistries`、`/v1/enterprise/registry/[id]/passport`、`/v1/enterprise/registry/[id]/benchmark`、`/v1/enterprise/registry/review-required`，返回治理 checklist、组织内证书/Passport、采用基线漂移告警、私有评测、批量重审、审计导出和企业失败库入口 |
